...
let baseUrlFeedMs = `http://${serverData.feed_url}:${serverData.feed_port}/${serverData.feed_entryPoint}`;
let baseUrlLabelsMs = `http://${serverData.labels_url}:${serverData.labels_port}/${serverData.labels_entryPoint}`;
